...
Evidence from a regression discontinuity analysis supports that participants monitored their day 1 plans despite ultimately exceeding them. When participants reached their planned typing duration, they immediately reduced typing probability by 25.5 percentage points in the next 60-second window. However, this effect dissipated quickly, becoming insignificant within 90 seconds, as participants returned to the typing task once again. 

Taken together, these findings cast doubt on whether the watching task was actually perceived as tempting. A mixed-method analysis of open-ended responses reveals that participants perceived the experimental environment as a work setting rather than a choice between independent tasks. While 29\% spontaneously described typing using negative terms, another 23\% characterized video-watching as ``taking breaks'' from work. This suggests that experimenter demand effects may have interfered with the intended effects of the autoplay manipulation, with implications for both the interpretation of our null results and the broader generalizability of our study.

A primary internal validity concern is that experimenter demand effects favored allocating more time on the typing task than planned. These can emerge through contextual cues even without explicit behavioral instructions, as participants interpret the unfamiliar experimental environment by drawing inferences from the information provided, and may alter their behavior simply by having attention drawn to variables of interest \citep{zizzo2010ee}. In our experiment, these could be (i) the small earnings difference favoring the typing task,\footnote{This difference is 60 pence over 20 minutes, equivalent to a 1.8 pound hourly wage difference (15\% above our 12 pound minimum wage baseline).} (ii) multiple mentions of the quality criteria for the typing task to receive earnings, (iii) placement of the typing task as the first activity upon starting a session. Alternative designs could have addressed these concerns by rewarding balanced time allocations more, or by eliminating earning differences altogether.

Another major challenge in isolating the effects of autoplay is the role of content appeal. Higher content appeal would make the watching task more tempting, and create a stronger tradeoff between the two tasks. To adress this while keeping the content identical across conditions, we conducted pretests from the same participant pool where the funny animal videos came out as the modal theme. In addition, participants rated the curated videos positively (median 7/10) in the post experiment survey. Regardless, the watching task lacked what participants could afford in terms of leisure - they could work harder for maximum earnings and wait 20 minutes to access personalized content privately. Allowing participants to select among a list of themes with manually curated videos could have adressed this issue \citep{ek2023too}.
...
% This finding characterizes autoplay in isolation as a interface default that facilitates desired content consumption instead of a threat to autonomy.

% We find no evidence that autoplay increases video consumption in our setting. Participants in both conditions watched similar numbers of videos and spent comparable amount of time tasks during the main session. Participants also had a positive WTP for having autoplay enabled, amounting to 45 seconds of typing task, or 2.24 pence. While day 1 plans of time allocation between tasks were identical between conditions, participants spent a significant 35\% more time on the effortful typing task than they had planned regardless of the conditions. This finding is driven by a third of our sample who had planned to spend up to three quarters of their time watching videos but instead decreased their content consumption on the next day. Second by second logs support this finding: Participants significantly reduced typing around the time window when they accomplished their day 1 plans, but eventually switched back to the typing task after some time. On the other end, 88\% of those who had initially planned to spend less than a quarter of their time watching videos successfully followed their plans and did not succumb to temptation. Analyzing free text input from participants revealed that while the typing task was unanimously connotated with negative emotions, video-watching task was perceived as ``taking breaks'' from the typing task. These help us conclude that participant perceptions of the decision-making environment altered their time allocation between the two tasks and confounded our findings regarding video watching behavior.
...
% We contribute to several strands of literature. First, the literature on effects of social media and streaming services on well-being \citep{allcott2022digital,allcott2020welfare, collis2022po, groshek2018p9icsms, walton-pattison2018jhp, braghieri2022aer,bursztyn2023,beknazar2025toxic,purohit2023starving,nyhan2023like}, and user agency \citep{lukoff2021design,bongard2021definitely,schaffner2025pahi,schaffner2023pahia, kleinberg2022challenge, mathur2021p2cchfcs, ichihashi2023addictive,chen2025, lyngs2019p2cchfcs, lyngs2020p2cchfcs, silverman2024, collis2019, hoong2021eer, lupianez-villanueva2022, bao2025just}. We contribute to this work by shedding light on one a potential driver of the harmful effects of social media and streaming services: the autoplay.

We contribute to several strands of literature. First, the literature on studying the effects of social media and streaming services on user well-being \citep{allcott2022digital,allcott2020welfare, collis2022po, groshek2018p9icsms, walton-pattison2018jhp, braghieri2022aer,bursztyn2023,beknazar2025toxic,purohit2023starving,nyhan2023like,bao2025just}. We contribute to this work by shedding light on one potential driver of the harmful effects of social media and streaming services: the autoplay.

A subset of this literature focuses on the effects of specific interface design elements on user behavior, particularly related to user agency and overconsumption of content \citep{lukoff2021design,bongard2021definitely,schaffner2025pahi,schaffner2023pahia, mathur2021p2cchfcs, lyngs2019p2cchfcs, lyngs2020p2cchfcs, silverman2024, lupianez-villanueva2022, chen2025,hoong2021eer}. To our knowledge, our paper provides the first attempt isolating the causal effects of autoplay on content consumption.

Methodologically, this paper contributes to the literature by introducing an experimental platform that directly records participant behavior and manipulates interface in an online setting. Similar approaches using browser extensions XX 
...
The remainder of this paper is organized as follows. Section 2 describes the experimental design. Section 3 details our sample and procedures. Section 4 presents our results and Section 5 concludes.
...
\footnotesize
\item[] \textit{Note:} This table shows the experimental components administered across two data collection waves, with columns ordered chronologically within each day. The first block (May 10-11 2023) established baseline treatment effects, while the second block (May 18-19 2023) incorporated the Multiple Price List treatment to measure demand for commitment devices. Decision horizon refers to the time between hypothetical preference elicitation and the main experimental session.
\end{tablenotes}
\label{summary_table}
\end{threeparttable}
\end{table}
...
\textbf{Hypothesis 1:} \textbf{Autoplay} condition decreases time allocated to the typing task while increasing video consumption. We test this using a linear regression:
...
\textbf{Hypothesis 3:} If participants are aware of their self-control issues, they should exhibit positive Willingness To Pay (WTP) for removing autoplay, preferring the commitment devices that restricts automatic video transitions. We test this using a logistic regression:
    \begin{equation}\label{eq2}
        \text{Pr}(\frac{\text{Autoplay}_{ij}}{1-\text{Autoplay}_{ij}}|\text{Bonus}_{ij}) = \Lambda(\alpha + \beta \text{Bonus}_{ij})
    \end{equation}

...
Autoplay---the automatic transition to new videos without user action---has become a defining feature of major social media and streaming platforms, including Facebook, Netflix, YouTube, TikTok, and Twitter. This ubiquitous design choice has attracted regulatory scrutiny: the U.S. SMART Act proposes banning platforms from serving content ``without an express, separate prompt by the user,'' explicitly labeling autoplay as an ``addictive'' feature that exploits users' self-control problems.\footnote{SMART Act of 2019, S. 2314, 116th Congress: \url{https://www.congress.gov/bill/116th-congress/senate-bill/2314/text}} Yet despite these strong policy claims and the feature's widespread adoption, we lack causal evidence on whether autoplay independently drive users to consume more content than they would choose to, or whether it merely reduces friction for consumption for already desired content?\footnote{When Twitter (currently X) first introduced autoplay in 2015, they described it as a means to reducing the ``effort'' and ``number of clicks'' to access content: \url{https://blog.x.com/official/en_us/a/2015/introducing-a-more-seamless-video-experience-with-autoplay.html}}

This question sits at the intersection of two distinct mechanisms through which platforms shape user behavior: algorithmic content curation and interface design. While recent work has examined how content algorithms affect consumption patterns \citep{nyhan2023like, beknazar2025toxic}, the role of interface defaults like autoplay remains understudied. While autoplay is pervasive \cite{chen2025} and correlates with increased viewing times \citep{hiniker2018coco,schaffner2025pahi}, earlier studies cannot isolate whether this effect stems from the interface feature itself or from platforms pairing autoplay with particularly engaging content. This identification challenge matters for policy---if autoplay merely facilitates desired consumption rather than creating unwanted overconsumption, then interface-level bans may be misguided paternalism that reduces user welfare without addressing genuine self-control problems.
...
In this paper, we present an incentivized online experiment designed to isolate the causal effect of autoplay on media consumption. We recruited 184 participants who allocated 20 minutes between a higher-paying typing task and a lower-paying video-watching task, with half randomly assigned to an autoplay condition where videos played continuously and half to a control condition requiring manual clicks to play each video. Participants first practiced both tasks and stated their preferred time allocation a day before the main session, allowing us to measure deviations from planned behavior. We find no evidence that autoplay increases video consumption: participants in both conditions watched similar numbers of videos and spent comparable time on the leisure task. Surprisingly, participants systematically spent more time on the effortful typing task than they had planned—the opposite of what models of present bias would predict. In a follow-up treatment, participants revealed a small positive Willingness To Pay (WTP) for having autoplay enabled, suggesting they view it as a convenience rather than a self-control threat.

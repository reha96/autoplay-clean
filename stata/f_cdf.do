...
graph bar work_in_period1 work_in_period2 work_in_period3 work_in_period4, ///
    ...
    bar(1, fcolor("255 182 193") lcolor(white)) ///
    bar(2, fcolor("218 165 32") lcolor(white)) ///
    bar(3, fcolor("50 205 50") lcolor(white)) ///
    bar(4, fcolor("64 224 208") lcolor(white)) ///
    title("Work Allocation by Time Quartiles") ///
    ytitle("Typing Time (seconds)") ///
    ylabel(0(300)1200, angle(0)) ///
    legend(order(1 "Q1 (0-5min)" 2 "Q2 (5-10min)" 3 "Q3 (10-15min)" 4 "Q4 (15-20min)") ///
           pos(10) rows(4) ring(0) region(lcolor(none))) $graph_opts ///

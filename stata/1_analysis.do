...
gen dev = type_act_prop-prop_typing_choice
sum dev
local mean1 = r(mean)
local sd1 = r(sd)
gen z_dev = (dev-`mean1')/(`sd1')

reg z_dev i.treatment, vce(robust)
reg z_dev i.treatment c.$x1, vce(robust)
reg z_dev i.treatment##c.$x1, vce(robust)
